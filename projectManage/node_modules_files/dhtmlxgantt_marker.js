...
gantt.attachEvent("onGanttReady", function(){
    ...
    gantt.event(div,'mousedown',mousedown);
    // gantt.event(div,'mouseout',mouseout);
    gantt.event(div,'mouseover',mouseover);
...
function mousedown(event) {
  ...
  document.onmouseup=function(){
    var date = gantt.dateFromPos(parseInt(div.style.left));
    gantt.callEvent("onAfterDragMarker", [date]);
